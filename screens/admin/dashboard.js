        ...
        {stats && (
          <View style={styles.stats}>
            <StatItem
              icon='users'
              label='Clients'
              value={stats.countUtilisateurs}
            />
            <StatItem icon='grid' label='Centres' value={stats.countCentres} />
            <StatItem
              icon='archive'
              label='Rendez-vous'
              value={stats.countRdv}
            />
            <StatItem
              icon='columns'
              label='Créneaux'
              value={stats.countCreneau}
            />
            <StatItem
              icon='list'
              label="Rendez-vous aujourd'hui"
              value={stats.countRdvAujourdhui}
            />
            <StatItem
              icon='list'
              label="Rendez-vous après aujourd'hui"
              value={stats.countRdvApresAujourdHui}
            />
            <StatItem
              icon='calendar'
              label='Date max Créneau'
              value={stats.dateMaxCreneau}
            />
          </View>
        )}
      </View>
