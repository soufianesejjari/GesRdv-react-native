    ...
    <View style={{...styles.tableRow, backgroundColor: index % 2 == 1 ? "#F0FBFC" : "white"}}>
      ...
      <RBSheet
        ...
        customStyles={{
          ...
          container: { // Add rounded borders
            marginHorizontal:1,
            borderTopLeftRadius: 35,
            borderTopRightRadius: 35,
            backgroundColor: "#fff"
          },
          closeButton: { // Add hint to close dropdown
            alignItems: "center",
            marginVertical: 10
          },
          closeButtonText: {
      ...
      >
         <View>
            ...
            <View style={{ backgroundColor: secondColor, ...styles.buttonModie }}>
            <Text style={styles.buttonText}>Modifie ce centre</Text>

            </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=>{handleCreneaux()}}>
